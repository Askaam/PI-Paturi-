            ...
            <div class="container">
                <div class="row mb-4 align-items-center">
					...
					<?php
                        ...
                        echo '<h1 class="fontlei">'.$row['nome_cli'].'</h1>';
                        echo '<p Class=fontcarac>'.$row['desc_cli'].'</p>';
                    echo '</div>';
                echo '</div>';
            echo '</div>';
            ...
            echo '<div class="site-section pb-0">';
                echo '<div class="container">';
                    echo '<div class="row align-items-stretch">';
                      ...
                      echo '<img src="../'.$row['caminho_img_cli'].'" alt="Image" class="img-fluid">';
                        ...
                        echo '<div class="col-md-3 ml-auto" data-aos="fade-up" data-aos-delay="100">';
                            echo '<div class="sticky-content">';
                                ...
                                echo '<ul class="list-unstyled list-line mb-5">';
                                    echo '<li class="fontcarac"><b>altura (com tampa):</b> '.$row['altura_cli'].' </li>';
                                    echo '<li class="fontcarac"><b>comprimento:</b> '.$row['comprimento_cli'].' cm</li>';
                                    echo '<li class="fontcarac"><b>largura:</b> '.$row['largura_cli'].' </li>';
                                    echo '<li class="fontcarac"><b>volume útil:</b> '.$row['volume_cli'].' </li>';
                                    echo '<li class="fontcarac"><b>peso médio (vazia):</b> '.$row['peso_cli'].' </li>';
                                    echo '<li class="fontcarac"><b>quantidade (por caixa):</b> '.$row['qtdCaixa_cli'].' </li>';
                                echo '</ul>';
