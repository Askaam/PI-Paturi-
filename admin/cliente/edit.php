...
$id_cli=$_GET['id_cli'];    //Pega a chave primária da linha que será editada
...
while($row = $query->fetch(PDO::FETCH_ASSOC))
{
    ...
    $desc_cli=$row['desc_cli'];
    $altura_cli=$row['altura_cli'];
    $comprimento_cli=$row['comprimento_cli'];	
	$largura_cli=$row['largura_cli'];
	$volume_cli=$row['volume_cli'];
	$peso_cli=$row['peso_cli'];
	$qtdCaixa_cli=$row['qtdCaixa_cli'];
}
        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Edição de Produto do Cliente</h4>
                            <p class="card-description">
                                <!-- Basic form elements -->
                            </p>
                            <form action="../../admin/cliente/update.php" method="post" name="cliente">

                                <div class="form-group">
                                    <label for="exampleInputName1">Nome do Produto:</label>
                                    <input type="text" class="form-control" name="nome" id="nome" value="<?php echo $nome_cli;?>">
                                </div>
                                
								<div class="form-group">
                                    <label for="exampleTextarea1">Descrição do Produto:</label>
                                    <input type="text" class="form-control" name="desc" id="desc" value="<?php echo $desc_cli;?>">
                                </div>
								
								<div class="form-group">
                                    <label for="exampleInputName1">Altura do Produto:</label>
                                    <input type="text" class="form-control" name="alt" id="alt" value="<?php echo $altura_cli;?>">
                                </div>
								
								<div class="form-group">
                                    <label for="exampleInputName1">Comprimento do Produto:</label>
                                    <input type="text" class="form-control" name="compri" id="compri" value="<?php echo $comprimento_cli;?>">
                                </div>
								
								<div class="form-group">
                                    <label for="exampleInputName1">Largura do Produto:</label>
                                    <input type="text" class="form-control" name="larg" id="larg" value="<?php echo $largura_cli;?>">
                                </div>
								
								<div class="form-group">
                                    <label for="exampleInputName1">Volume do Produto:</label>
                                    <input type="text" class="form-control" name="vol" id="vol" value="<?php echo $volume_cli;?>">
                                </div>
								
								<div class="form-group">
                                    <label for="exampleInputName1">Peso do Produto:</label>
                                    <input type="text" class="form-control" name="peso" id="peso" value="<?php echo $peso_cli;?>">
                                </div>
								
								<div class="form-group">
                                    <label for="exampleInputName1">Quantidade de Produto Por Caixa:</label>
                                    <input type="text" class="form-control" name="qtd" id="qtd" value="<?php echo $qtdCaixa_cli;?>">
                                </div>									                                							
