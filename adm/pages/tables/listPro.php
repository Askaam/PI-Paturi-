...
<body>
  ...
  while($row = $result->fetch(PDO::FETCH_ASSOC)){
    ...
    echo "<td>".$row['altura_pro']."</td>";
    echo "<td>".$row['comprimento_pro']."</td>";
    echo "<td>".$row['largura_pro']."</td>";
    echo "<td>".$row['volume_pro']."</td>";
    echo "<td>".$row['peso_pro']."</td>";
    echo "<td>".$row['qtdCaixa_pro']."</td>";
	echo "<td><a href =\"../../../admin/produto/edit.php?id_pro=$row[id_pro]\"><span class='ti-pencil'></span></a></td>";
	echo "<td><a href =\"../../../admin/produto/delete.php?id_pro=$row[id_pro]\"onClick=\"return confirm('Você deseja exluir os dados?')\"><span class='ti-trash'></span></a></td>";
	echo "</tr>";
    }
  ?>
                                                <tr>
