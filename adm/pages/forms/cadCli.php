                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="cad">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link" href="cadCli.php"> Clientes </a></li>
                            <li class="nav-item"> <a class="nav-link" href="cadPro.php"> Produtos </a></li>
        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Cadastro de Produto do Cliente</h4>
                            <p class="card-description">
                                <!-- Basic form elements -->
                            </p>
                            <form action="../../../admin/cliente/insert.php" method="post" name="produto" enctype="multipart/form-data">
